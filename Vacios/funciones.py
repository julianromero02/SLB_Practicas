...
def distanciaReal(inicio, fin):
    ...
    location_mapping = {
        ...
        "RUBIALES": "RUBIALES,PUERTO GAITAN,META",
        "CUERNAVACA":"CUERNAVACA,PUERTO GAITAN",
    ...
    if hasattr(Origen, 'longitude') and hasattr(Origen, 'latitude') and hasattr(Destino, 'longitude') and hasattr(Destino, 'latitude'):
        ...
        try:
            ...
            if "routes" in data and len(data["routes"]) > 0:
                ...
                distancia = "No se pudo calcular la distancia"  # Asignar un valor predeterminado aquí
                return distancia
